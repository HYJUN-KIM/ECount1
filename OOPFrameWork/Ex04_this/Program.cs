...
namespace Ex04_this
{
    ...
    class ThisSelf
    {
        ...
        */
        ...
        public ThisSelf(string name, int age)
        {
            //member field 할당을 한 번만 (반복적인 코드 줄임)
            this.name = name;
            this.age = age;
            Console.WriteLine("매개변수가 2개 : {0} - {1}", this.name, this.age);
        }
    }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //원칙적으로 생성자 함수는 객체 생성 시 1개만 호출
            //예외) 내부적으로 this() 구현한다면 여러 개의 생성자 호출 가능
